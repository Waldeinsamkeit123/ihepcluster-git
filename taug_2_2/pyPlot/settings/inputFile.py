...
httg = sample(name="httg",        legendName="httg",                color=kMagenta,         lineStyle=1,    markerStyle=21)
httg.treeName = "LHEF"
httg.inFile =  "/publicfs/cms/user/wanghan/code/taug_2_2/unweighted_events.root"
...
stackSampleList.append(httg);         totalSampleList.append(httg)
