...
Wt          = sample(name="Wt",        legendName="tW",         color=kAzure-3,     lineStyle=1,    markerStyle=21)
Wt.treeName = "Trees"+channel+"/NJets_noSyst"
tchannel    = sample(name="tchannel",  legendName="t\\bar{t}",  color=kRed+2,       lineStyle=1,    markerStyle=22)
tchannel.treeName = "Trees"+channel+"/NJets_noSyst"
schannel    = sample(name="schannel",  legendName="t\\bar{t}",  color=kRed+2,       lineStyle=1,    markerStyle=22)
...
wjets       = sample(name="wjets",     legendName="t\\bar{t}",  color=kRed+2,       lineStyle=1,    markerStyle=22)
...
#allSChannel,diBoson,allTChannel,QCD,ZJets,tW,WJets,TTBar
